...
class TestRegistration:
    ...
    #     ## The function below is commented out because random 
    ...
    def test_invalid_phone_number_on_registration(self):
        ...
        register.assert_correct_notification_message("Invalid mobile number")
        register.capture_screen_shot("failed_registation.png")